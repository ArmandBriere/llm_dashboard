...
const NAV_ICONS = {
  overview: '<path d="M2.4 2.4h4.4v4.4H2.4zM9.2 2.4h4.4v4.4H9.2zM2.4 9.2h4.4v4.4H2.4zM9.2 9.2h4.4v4.4H9.2z"/>',
  ...
  models: '<path d="M8 1.8 14.2 5 8 8.2 1.8 5z"/><path d="m1.8 8 6.2 3.2L14.2 8"/><path d="m1.8 11 6.2 3.2L14.2 11"/>',
  activity: '<path d="M1.6 8.4h3L6.3 3.6l2.6 8.8 1.6-4h3.9"/>',
  projects: '<path d="M1.8 12.6V3.8a.8.8 0 0 1 .8-.8h3.2l1.4 1.8h6a.8.8 0 0 1 .8.8v7a.8.8 0 0 1-.8.8H2.6a.8.8 0 0 1-.8-.8z"/>',
  sessions: '<path d="M5.6 4h8.2M5.6 8h8.2M5.6 12h8.2"/><path d="M2.4 4h.02M2.4 8h.02M2.4 12h.02"/>',
  skills: '<path d="m8 1.8 1.7 4.5 4.5 1.7-4.5 1.7L8 14.2 6.3 9.7 1.8 8l4.5-1.7z"/>',
  plugins: '<path d="M4.6 1.8v3.2M11.4 1.8v3.2"/><path d="M2.8 5h10.4v3.4a5.2 5.2 0 0 1-10.4 0z"/><path d="M8 13.6v.6"/>',
  tools: '<path d="M10.2 2.2a3.6 3.6 0 0 0-4.3 4.3L2.4 10a1.5 1.5 0 0 0 2.1 2.1l3.5-3.5a3.6 3.6 0 0 0 4.3-4.3l-2 2-1.6-.4-.4-1.6z"/>',
};
...
function renderNav() {
  ...
  nav.innerHTML = NAV_GROUPS.map((group) => {
    ...
    const head = group.label ? `<span class="label nav-group-head">${escapeHtml(group.label)}</span>` : "";
